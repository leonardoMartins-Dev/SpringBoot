...
- Java 21+ (o projeto foi compilado com `release 25`, ajuste conforme sua versão do JDK)
- Maven (ou use o wrapper `./mvnw` incluso no projeto)

### Rodando localmente

Na raiz do projeto, use o goal do plugin do Spring Boot (repare nos dois-pontos, não espaço):
...
Para compilar e rodar os testes antes:
...
- Estações de Rádio
- Estações em Minas Gerais, Belo Horizonte
- Estação Itatiaia
